...
function UserManagementTable() {
    _s();
    const { data: profiles, loading, update } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$hooks$2f$useSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabase"])("profiles");
    ...
    const handleAction = async (id, updates, actionLabel)=>{
        try {
            await update(id, updates);
            __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Protocol executed: User ${actionLabel} successfully.`, {
                description: `The grid profile for node ${id.slice(0, 8)} has been updated.`
            });
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Protocol failure: Database update intercepted.", {
                description: "Check secure session and RLS permissions."
            });
        }
    };
...
_s(UserManagementTable, "jjQzP3+tRHY+Xx0X/ZxYcPsE4Vc=", false, function() {
    return [
...
//# sourceMappingURL=NexaMind_DSM_d21d8b03._.js.map