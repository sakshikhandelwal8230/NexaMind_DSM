...
function TransfersPage() {
    ...
    const { data: transfers, loading, update, remove } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$hooks$2f$useSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabase"])("transfers");
        ...
        "TransfersPage.useMemo[stats]": ()=>{
            ...
            return {
                ...
                pending: transfers.filter({
                    "TransfersPage.useMemo[stats]": (t)=>t.status === "requested"
                }["TransfersPage.useMemo[stats]"]).length,
                inTransit: transfers.filter({
                    "TransfersPage.useMemo[stats]": (t)=>t.status === "dispatched"
                }["TransfersPage.useMemo[stats]"]).length,
                delivered: transfers.filter({
                    "TransfersPage.useMemo[stats]": (t)=>t.status === "received"
                }["TransfersPage.useMemo[stats]"]).length,
                critical: transfers.filter({
                    "TransfersPage.useMemo[stats]": (t)=>t.priority === "critical"
                }["TransfersPage.useMemo[stats]"]).length
            };
        }
    }["TransfersPage.useMemo[stats]"], [
    ...
    const filteredTransfers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransfersPage.useMemo[filteredTransfers]": ()=>{
            if (!transfers) return [];
            return transfers.filter({
                "TransfersPage.useMemo[filteredTransfers]": (t)=>t.medicine_name.toLowerCase().includes(localSearch.toLowerCase()) || t.to_facility?.toLowerCase().includes(localSearch.toLowerCase()) || t.from_facility?.toLowerCase().includes(localSearch.toLowerCase())
            }["TransfersPage.useMemo[filteredTransfers]"]);
        }
    }["TransfersPage.useMemo[filteredTransfers]"], [
        transfers,
    ...
    const updateStatus = async (id, newStatus)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Transfer status updated to ${newStatus}`);
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update status");
        }
    };
    const deleteTransfer = async (id)=>{
        try {
            await remove(id);
            __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Transfer request cancelled.");
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete.");
        }
    };
                                                            ...
                                                            children: loading ? [
                                                                ...
                                                                columnNumber: 25
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-black text-[9px] uppercase tracking-tighter", t.priority === 'critical' ? "bg-red-600 text-white" : "bg-primary/10 text-primary border-primary/20"),
                                                                                children: t.priority
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/NexaMind_DSM/app/transfers/page.tsx",
                                                                                lineNumber: 115,
...
_s(TransfersPage, "OPAJK9zAAowDi5E89t7QNIDQ48g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$hooks$2f$useSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabase"]
    ];
});
...
function StatCard({ title, value, icon: Icon, color }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("border-l-4 shadow-xl transition-all duration-300 hover:scale-105", colors[color]),
        children: [
...
//# sourceMappingURL=NexaMind_DSM_e2eaf6d7._.js.map