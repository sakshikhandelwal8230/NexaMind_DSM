...
function InventoryPage() {
    _s();
    const { insert, update: updateMedicine, remove, subscribe } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$hooks$2f$useSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabase"])("medicines");
            ...
            const unsubscribe = subscribe({
                "InventoryPage.useEffect.unsubscribe": (data)=>{
                    ...
                    const mapped = data.map({
                        "InventoryPage.useEffect.unsubscribe.mapped": (item)=>({
                                id: item.id,
                                name: item.name,
                    ...
                    }["InventoryPage.useEffect.unsubscribe.mapped"]);
                    setMedicines(mapped);
                    setLoading(false);
                }
...
_s(InventoryPage, "dBYIEXo0vMjI+fB+C5mM2uLRzvM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$NexaMind_DSM$2f$hooks$2f$useSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabase"]
    ];
});
...
//# sourceMappingURL=NexaMind_DSM_e6fb6b69._.js.map